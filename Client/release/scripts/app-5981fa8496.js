...
(function () {
    ...
    function routeConfig($stateProvider) {
        getAnnotationTask.$inject = ["AnnotationTextService", "$stateParams", "DataService", "restrictionsValidatorService"];
...
(function () {
  'use strict';
	...
	httpService.$inject = ["$http", "$q", "$timeout", "$rootScope", "$location", "ENV_CONST", "Core", "storageService"];
  angular.module('zAdmin.http',[
  	'zAdmin.const'
  	])
...
(function () {
  ...
  AnnotationPageCtrl.$inject = ["DefaultHotKeys", "TaskMetaData", "AnnotationTextService", "DataService", "$rootScope", "$scope", "hotkeys", "HotKeysManager", "Definitions", "ENV_CONST", "Core", "restrictionsValidatorService"];
  angular.module('zAdmin.pages.annotation')
...
(function () {
    ...
    innerTableCtrl.$inject = ["$scope", "$state", "$rootScope", "apiService"];
    angular.module('zAdmin.theme')
...
(function() {
    ...
    DataService.$inject = ["$http", "apiService", "$rootScope", "restrictionsValidatorService", "ENV_CONST", "Core"];
    angular.module('zAdmin.annotation.data')
...
(function() {
    ...
    annotationUnitDirective.$inject = ["$rootScope", "DataService", "HotKeysManager", "hotkeys", "DefinitionsService", "$timeout", "$compile", "$uibModal", "restrictionsValidatorService", "ENV_CONST", "Core"];
    angular.module('zAdmin.annotation.directives')
    ...
    function annotationUnitDirective($rootScope,DataService,HotKeysManager,hotkeys,DefinitionsService, $timeout, $compile, $uibModal,restrictionsValidatorService, ENV_CONST, Core) {
        ...
        function getCurrentDataBlock(dataService,directiveIndex){
            ...
            tempObject = dataService.tree.AnnotationUnits[parseInt(splittedDirectiveIndex[0]) - 1];
            for (var i=1; i<splittedDirectiveIndex.length; i++){
                tempObject = tempObject.AnnotationUnits[parseInt(splittedDirectiveIndex[i]) - 1];
            }
...
(function() {
    ...
    DefinitionsController.$inject = ["$scope", "$rootScope", "DataService", "$timeout", "$uibModal", "restrictionsValidatorService", "Core"];
    angular
...
(function() {
    ...
    goToUnitDirective.$inject = ["$rootScope", "DataService"];
    angular
        .module('zAdmin.annotation.directives')
...
(function() {
    ...
    DefinitionsController.$inject = ["$scope", "$rootScope", "DataService", "$timeout", "$compile"];
    angular
        .module('zAdmin.annotation.directives')
...
(function () {
    ...
    editTokenizationTasksService.$inject = ["apiService", "Core"];
    angular.module('zAdmin.pages.edit.tasks.tokenization')
...
(function () {
    ...
    EditRootLayerCategoriesCtrl.$inject = ["$scope", "$state", "EditTableStructure", "editRootLayerService", "editRootLayerCategoriesService", "Core", "EditTableData", "$uibModal"];
    angular.module('zAdmin.pages.edit.layers.root.categories')
...
(function () {
    ...
    EditTokenizationTaskAnnotatorCtrl.$inject = ["$scope", "$state", "EditTableStructure", "editTokenizationTaskAnnotatorService", "editTokenizationTasksService", "Core"];
    angular.module('zAdmin.pages.edit.tasks.tokenization.annotator')
...
(function () {
    ...
    EditTokenizationTaskPassagesCtrl.$inject = ["$scope", "$state", "EditTableStructure", "editTokenizationTaskPassagesService", "editTokenizationTasksService", "Core"];
    angular.module('zAdmin.pages.edit.tasks.passages')
...
angular.module("zAdmin").run(["$templateCache", function($templateCache) {$templateCache.put("app/pages/annotation/annotation-page.html","<div class=\"annotation-page-container\"><div class=\"col-xs-2 side-bar\"><div class=\"categories-container\"><categories-directive ng-repeat=\"category in vm.categories track by $index\" definition-details=\"category\" definition-id=\"$index\"></categories-directive></div><div class=\"utility-buttons-container\"><utility-buttons-directive ng-repeat=\"definition in vm.definitions track by $index\" definition-details=\"definition\" definition-id=\"$index\"></utility-buttons-directive></div></div><div class=\"col-xs-10 main-body\"><div class=\"nav-bar-container\"><nav-bar-item ng-repeat=\"item in vm.navBarItems track by $index\" tool-tip=\"item.tooltip\"></nav-bar-item><div class=\"available-font-sizes\"><div class=\"btn-group\" uib-dropdown=\"\" dropdown-append-to-body=\"\"><button type=\"button\" class=\"btn btn-primary\" uib-dropdown-toggle=\"\">Font Size <span class=\"caret\"></span></button><ul uib-dropdown-menu=\"\"><li ng-repeat=\"fz in vm.fontSizes\" ng-click=\"vm.setFontSize(fz)\"><a href=\"\">{{::fz.preview}}</a></li></ul></div></div></div><div class=\"col-xs-12 manager-comment-container alert bg-info closeable\" ng-show=\"!vm.showManagerComment\"><div class=\"title-and-close-container\"><span class=\"title manager_comment\">{{vm.tokenizationTask.manager_comment}}</span> <i class=\"ion-close-round\" id=\"hide-manager-comment\" ng-click=\"vm.showManagerComment = !vm.showManagerComment\"></i></div></div><annotation-units class=\"has-elements\" preview-line=\"vm.wrappedText\" control=\"vm.keyController\" line-id=\"0\"></annotation-units><div class=\"categorized-words-container\"><div class=\"categorized-word\" ng-repeat=\"lineObj in vm.dataTree\" ng-class=\"{ \'remote-unit\':lineObj.unitType == \'REMOTE\' || lineObj.unitType == \'IMPLICIT\', \'highlight-unit\':lineObj.unitType == \'REMOTE\' || lineObj.unitType == \'IMPLICIT\', \'hidden\':lineObj.gui_status==\'HIDDEN\', \'closed-annotation-unit\':lineObj.gui_status==\'COLLAPSE\' }\"><div ng-show=\"lineObj.AnnotationUnits.length\" class=\"expand-btn\" ng-click=\"vm.toggleAnnotationUnitView($event)\"><i ng-class=\"{\'ion-minus-round\':lineObj.gui_status==\'OPEN\', \'ion-plus-round\':lineObj.gui_status==\'COLLAPSE\'}\" id=\"{{lineObj.annotation_unit_tree_id}}\"></i></div><annotation-units class=\"has-elements\" preview-line=\"lineObj.text\" categories=\"lineObj.categories\" control=\"vm.keyController\" line-id=\"lineObj.annotation_unit_tree_id\"></annotation-units></div></div></div></div>");
$templateCache.put("app/pages/auth/auth.html","<div class=\"\"><div class=\"row ucca-reg-header\"><div class=\"col-md-6\"><a href=\"http://www.cs.huji.ac.il/\" target=\"_blank\"><img src=\"http://www.cs.huji.ac.il/imagesl/cse_banner.jpg\" style=\"max-width: 100%;\" align=\"left\"></a></div><div class=\"col-md-6 visible-lg-*\"><div class=\"visible-lg-*\"><a href=\"http://new.huji.ac.il/en\" target=\"_blank\"><img src=\"http://www.cs.huji.ac.il/imagesl/huji_banner.png\" style=\"padding-top:7px\" align=\"right\"></a></div></div></div><nav class=\"navbar navbar-default\"><div class=\"container-fluid bg-primary\"><div class=\"navbar-header\"><a href=\"#\" class=\"navbar-brand\" style=\"color:#fff\">UCCA</a></div></div></nav><div class=\"container\"><div class=\"row auth-main\"><div class=\"auth-block\"><h1>Sign in to UCCA Admin</h1><a ui-sref=\"reg\" class=\"auth-link\">New to UCCA Admin? Sign up!</a><form class=\"form-horizontal\" id=\"login-form\" name=\"vm.loginDetails\" novalidate=\"\"><div class=\"form-group\" ng-class=\"{\'has-error\': vm.loginDetails.email.$invalid && (vm.loginDetails.email.$dirty || vm.loginDetails.$submitted)}\" style=\"\"><label for=\"exampleInputEmail1\" class=\"col-sm-2 control-label\">Email</label><div class=\"col-sm-10\"><input type=\"email\" class=\"form-control\" id=\"exampleInputEmail1\" name=\"email\" placeholder=\"Email\" ng-model=\"vm.personalInfo.email\" ng-init=\"vm.personalInfo.email=\'yarin@zigit.co.il\'\" required=\"\" style=\"\"> <span class=\"help-block error-block basic-block\">Proper email required</span></div></div><div class=\"form-group\" ng-class=\"{\'has-error\': vm.loginDetails.password.$invalid && (vm.loginDetails.password.$dirty || vm.loginDetails.$submitted)}\" style=\"\"><label for=\"exampleInputEmail1\" class=\"col-sm-2 control-label\">Password</label><div class=\"col-sm-10\"><input type=\"password\" class=\"form-control\" id=\"inputPassword3\" name=\"password\" placeholder=\"Password\" ng-model=\"vm.personalInfo.password\" ng-init=\"vm.personalInfo.password=\'Zigit1346!\'\" required=\"\" style=\"\"> <span class=\"help-block error-block basic-block\">Proper email required</span></div></div><div class=\"form-group\"><div class=\"col-sm-offset-2 col-sm-10\"><button type=\"submit\" class=\"btn btn-default btn-auth\" ng-click=\"vm.login();\">Sign in</button> <a href=\"\" class=\"forgot-pass\" ng-click=\"vm.forgotPassword()\">Forgot password?</a></div></div></form></div></div><div class=\"row\"><div class=\"col-md-12\"><div><h1>The UCCA Project</h1><p>Universal Conceptual Cognitive Annotation (UCCA) is a novel semantic approach to grammatical representation. It was developed in the Computational Linguistics Lab of the Computer Science Department of the Hebrew University by Omri Abend and Ari Rappoport.</p><p>UCCA uses purely semantic categories and DAG structures to analyze and annotate the semantics of natural languages. The basic set of semantic categories (the foundational layer) is inspired by work in linguistic typology, cognitive grammar, and neuroscience. The annotation so far focused on argument-structure and linkage phenomena.</p><p>We have annotated 160K tokens from English Wikipedia with the UCCA scheme, as well as a 30K English-French parallel corpus. A German annotation project is also underway.</p><p>Due to the complexity of semantic structures, there are often many applicable annotations for a given text. For practical reasons, we select a small set of highly useful distinctions, and apply them to provide one plausible annotation (interpretation).</p></div><div><h2>About UCCA</h2><p>UCCA (Universal Conceptual Cognitive Annotation) (Abend and Rappoport, 2013) is a cross-linguistically applicable scheme for semantic annotation. Formally, an UCCA structure is a directed acyclic graph (DAG), whose leaves correspond to the words of the text. The graph&rsquo;s nodes, called units, are either terminals or several elements jointly viewed as a single entity according to some semantic or cognitive consideration. Edges bear a category, indicating the role of the sub-unit in the structure the unit represents. UCCA&rsquo;s basic inventory of distinctions (its foundational layer) focuses on argument structures (adjectival, nominal, verbal and others) and relations between them. The most basic notion is the Scene, which describes a movement, an action or a state which persists in time. Each Scene contains one main relation and zero or more participants.</p><p>For example, the sentence &ldquo;After graduation, Tom moved to America&rdquo; (see figure) contains two Scenes, whose main relations are &ldquo;graduation&rdquo; and &ldquo;moved&rdquo;. The participant &ldquo;Tom&rdquo; is a part of both Scenes, while &ldquo;America&rdquo; only of the latter. Further categories account for inter-scene relations and the sub-structures of participants and relations.</p><p>UCCA is supported by extensive typological cross-linguistic evidence and accords with the leading Cognitive Linguistics theories. We build primarily on Basic Linguistic Theory (BLT) (Dixon, 2005; 2010a; 2010b; 2012), a typological approach to grammar successfully used for the description of a wide variety of languages. BLT uses semantic similarity as its main criterion for categorizing constructions both within and across languages. UCCA takes a similar approach, thereby creating a set of distinctions that is motivated cross-linguistically.</p><p></p><h3>References</h3><ul><li>Omri Abend and Ari Rappoport. 2013. Universal conceptual cognitive annotation (UCCA). In ACL 2013, pages 228&ndash;238.</li><li>Robert M. W. Dixon. 2005. A Semantic Approach To English Grammar. Oxford University Press.</li><li>Robert M. W. Dixon. 2010a. Basic Linguistic Theory: Methodology, volume 1. Oxford University Press.</li><li>Robert M. W. Dixon. 2010b. Basic Linguistic Theory: Grammatical Topics, volume 2. Oxford University Press.</li><li>Robert M. W. Dixon. 2012. Basic Linguistic Theory: Further Grammatical Topics, volume 3. Oxford University Press.</li></ul><p></p></div><div><h2>Contact Us</h2><p>With any questions, please contact:</p><p><a href=\"http://www.cs.huji.ac.il/~oabend/\" target=\"_blank\">Omri Abend</a><br>School of Computer Science and Engineering<br>The Hebrew University of Jerusalem<br>e-mail: oabend at cs dot huji dot ac dot</p></div></div></div></div></div>");
$templateCache.put("app/pages/categories/categories.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\">Add New category</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Categories Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
...
$templateCache.put("app/pages/edit/edit.html","<div class=\"row\"><div class=\"col-md-6\" ba-panel=\"\"><div class=\"row\"><field class=\"form-field col-md-12\" ng-repeat=\"formElem in vm.smartTableStructure | orderBy:\'order\' track by $index\" ng-if=\"formElem.showInTable\"></field></div><button type=\"submit\" class=\"btn btn-primary\" ng-click=\"vm.upsert(vm.smartTableStructure);\">Submit</button> <button type=\"button\" class=\"btn btn-danger\" ng-click=\"vm.back();\">Cancel</button></div><div class=\"col-md-6\"><ui-view></ui-view></div></div>");
$templateCache.put("app/pages/layers/layers.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({\'type\':\'Root\'})\">Add New Layer</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Sources Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
$templateCache.put("app/pages/maps/maps.html","<div class=\"widgets\"><div class=\"row\"><div class=\"col-md-12\" ui-view=\"\"></div></div></div>");
$templateCache.put("app/pages/passages/passages.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\">Add New Passage</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Passages Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
...
$templateCache.put("app/pages/projects/projects.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\">Create New Project</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Users Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
$templateCache.put("app/pages/reg/reg.html","<main class=\"auth-main\"><div class=\"auth-block\"><h1>Sign up to UCCA Admin</h1><a ui-sref=\"auth\" class=\"auth-link\">Already have a UCCA Admin account? Sign in!</a><form class=\"form-horizontal\"><div class=\"form-group\"><label for=\"inputEmail3\" class=\"col-sm-12 control-label\">Email :</label><div class=\"col-sm-12\"><input type=\"email\" class=\"form-control\" id=\"inputEmail3\" placeholder=\"Email\" ng-model=\"vm.GuestUserDetailes.email\"></div></div><div class=\"form-group\"><label for=\"inputFisrtName3\" class=\"col-sm-12 control-label\">First Name :</label><div class=\"col-sm-12\"><input type=\"text\" class=\"form-control\" id=\"inputFisrtName3\" placeholder=\"First name\" ng-model=\"vm.GuestUserDetailes.first_name\"></div></div><div class=\"form-group\"><label for=\"inputLastName3\" class=\"col-sm-12 control-label\">Last Name :</label><div class=\"col-sm-12\"><input type=\"text\" class=\"form-control\" id=\"inputLastName3\" placeholder=\"Last Name\" ng-model=\"vm.GuestUserDetailes.last_name\"></div></div><div class=\"form-group\"><label for=\"inputAfflliation3\" class=\"col-sm-12 control-label\">Affiliation :</label><div class=\"col-sm-12\"><input type=\"text\" class=\"form-control\" id=\"inputAfflliation3\" placeholder=\"Affiliation\" ng-model=\"vm.GuestUserDetailes.affiliation\"></div></div><div class=\"form-group\"><label for=\"inputOrganization3\" class=\"col-sm-12 control-label\">Organization :</label><div class=\"col-sm-12\"><input type=\"text\" class=\"form-control\" id=\"inputOrganization3\" placeholder=\"Organization\" ng-model=\"vm.GuestUserDetailes.organization\"></div></div><div class=\"form-group\"><div class=\"col-sm-12 sign-up-btn-container\"><button type=\"submit\" class=\"btn btn-default btn-auth\" ng-click=\"vm.register();\">Sign up</button></div></div></form><div class=\"auth-sep\"><span><span>or Sign up with one click</span></span></div><div class=\"al-share-auth\"><ul class=\"al-share clearfix\"><li><i class=\"socicon socicon-facebook\" title=\"Share on Facebook\"></i></li><li><i class=\"socicon socicon-twitter\" title=\"Share on Twitter\"></i></li><li><i class=\"socicon socicon-google\" title=\"Share on Google Plus\"></i></li></ul></div></div></main>");
$templateCache.put("app/pages/sources/sources.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\">Add New source</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Sources Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
$templateCache.put("app/pages/tasks/tasks.html","<div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Sources Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
$templateCache.put("app/pages/tokenization/tokenization-page.html","<div class=\"tokenization-page row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"\" ba-panel-class=\"medium-large-panel light-text\"><div class=\"panel-heading clearfix tokenization-panel-header\"><div class=\"button-container\"><button type=\"button\" class=\"btn btn-default btn-raised\" ng-click=\"vm.saveChanges()\">Save</button> <button type=\"button\" class=\"btn btn-default btn-raised\" ng-click=\"vm.initText()\">Discard</button></div></div><div ucca-tokenizer=\"\" passage-text=\"vm.passageText\" tokenized-text=\"vm.tokenizedText\" text-tokens=\"vm.textTokens\" class=\"panel-body text-container\"><div highlight-original-token=\"\" original-text=\"vm.originalText\" saved-tokens=\"vm.textTokens\" placeholder=\"Default Input\" class=\"large-panel form-control tokenization-text\" id=\"textarea-tokenizer\" contenteditable=\"true\" restrict-keys-tokenizer=\"\">{{vm.tokenizedText}}</div></div></div><div class=\"col-xs-6 panel-body\"><h5>textTokens json</h5><h6>Models of tokens</h6><div>The model is created by the gui and it is duplicating the python code. The property of require_annotation will be added by the python code upon saving since js can\'t handle it well.</div><pre>{{vm.textTokens | json}}</pre></div><div class=\"col-xs-6 panel-body\"><h5>Sent</h5><h6>Object of task</h6><div>This model represent the task object that is sent to the server.</div><pre>{{vm.tokenizationTask | json}}</pre></div></div></div>");
$templateCache.put("app/pages/users/users.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\" permission=\"\" permission-only=\"\'ADMIN\'\">Add New User</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Users Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
$templateCache.put("app/pages/project_tasks/project.tasks.html","<div><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\" ng-if=\"vm.projectLayerType\">New Tokenization Task</button></div><div ba-panel=\"\" ba-panel-title=\"Search Form {{vm.projectId ? \'PROJECT ID#\'+vm.projectId : \'\'}}\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Project {{ \'ID#\'+vm.projectId }} Task Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
$templateCache.put("app/pages/annotation/templates/categoryInfo.html","<div class=\"modal-content category-info\"><div class=\"modal-header bg-danger\"><i class=\"ion-flame modal-icon\"></i><span>{{name}}</span></div><div class=\"modal-body text-center\">{{description}}</div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-danger\" ng-click=\"$dismiss()\">OK</button></div></div>");
...
$templateCache.put("app/pages/tables/widgets/smartInnerTable.html","<div><div class=\"manage-button-container\"><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.manage({})\" ng-if=\"viewOnly != true\">Choose</button></div><div ba-panel=\"\" ba-panel-title=\"Selected {{pageName}}\" ba-panel-class=\"with-scroll\"><div class=\"horizontal-scroll\"><table class=\"table\" st-table=\"vm.smartTableData\" ng-class=\"{\'table-striped\': viewOnly == true}\"><thead><tr class=\"sortable\"><th st-sort=\"{{header.key}}\" ng-repeat=\"header in vm.smartTableStructure track by $index\" ng-if=\"header.showInTable\">{{::header.name}}</th></tr></thead><tbody ui-sortable=\"\" is-sortable=\"isSortable\" ng-model=\"vm.smartTableData\"><tr ng-model=\"vm.smartTableData\" ng-repeat=\"itemRow in vm.smartTableData\"><td ng-repeat=\"(key,value) in vm.smartTableStructure track by $index\" language-align=\"{{::itemRow[value[\'key\']]}}\" ng-class=\"{\'table-id\':$index==0,\'table-object\':itemRow[value[\'key\']].name}\" ng-click=\"!!itemRow[value[\'key\']].name && vm.showMore(itemRow[value[\'key\']]);\" ng-if=\"value.showInTable && value.key != \'actions\'\">{{::(itemRow[value[\'key\']].name || itemRow[value[\'key\']] )}}</td><td ng-if=\"vm.smartTableStructure[vm.smartTableStructure.length-1].buttons\"><span data-ng-switch=\"\" on=\"vm.smartTableStructure[vm.smartTableStructure.length-1].buttons.length<4\"><span data-ng-switch-when=\"true\"><input ng-repeat=\"action in vm.smartTableStructure[vm.smartTableStructure.length-1].buttons track by $index\" bs-switch=\"\" ng-if=\"action.showAs == \'switch\'\" ng-model=\"itemRow.selected\" switch-size=\"mini\" ng-change=\"vm.toggleItem(itemRow,itemRow.selected)\" type=\"checkbox\"> <button ng-if=\"!action.showAs\" ng-repeat=\"action in vm.smartTableStructure[vm.smartTableStructure.length-1].buttons track by $index\" class=\"btn editable-table-button btn-xs {{action.class}}\" ng-click=\"vm[action.functionName](itemRow,$parent.$parent.$index)\">{{::action.name}}</button></span><div data-ng-switch-when=\"false\"><div class=\"btn-group\" uib-dropdown=\"\" dropdown-append-to-body=\"\"><button type=\"button\" class=\"btn btn-primary\">Actions</button> <button type=\"button\" class=\"btn btn-primary\" uib-dropdown-toggle=\"\"><span class=\"caret\"></span> <span class=\"sr-only\">Toggle Dropdown</span></button><ul uib-dropdown-menu=\"\"><li><a href=\"\" ng-repeat=\"action in vm.smartTableStructure[vm.smartTableStructure.length-1].buttons track by $index\" ng-click=\"vm[action.functionName](itemRow,$parent.$index)\">{{::action.name}}</a></li></ul></div></div></span></td></tr></tbody></table></div></div></div>");
$templateCache.put("app/pages/tables/widgets/smartTable.html","<div class=\"horizontal-scroll\"><div class=\"form-group select-page-size-wrap\"><label>Rows on page<select class=\"form-control selectpicker show-tick\" title=\"Rows on page\" selectpicker=\"\" ng-model=\"vm.smartTablePageSize\" ng-options=\"i for i in [5,10,15,20,25]\"></select></label></div><table class=\"table\" st-table=\"vm.smartTableData\" st-safe-src=\"vm.smartTableDataSafe\"><thead><tr class=\"sortable\"><th st-sort=\"{{header.key}}\" ng-repeat=\"header in vm.smartTableStructure track by $index\" ng-if=\"header.showInTable\">{{::header.name}}</th></tr><tr><th ng-repeat=\"header in vm.smartTableStructure\" ng-if=\"header.filter\"><input st-search=\"{{header.key}}\" placeholder=\"{{header.name}}\" class=\"input-sm form-control search-input\" type=\"search\"></th></tr></thead><tbody><tr ng-repeat=\"itemRow in vm.smartTableData\" id=\"smart-table-row-{{$index}}\" ng-class=\"{\'selected\': itemRow.selected}\"><td ng-repeat=\"(key,value) in vm.smartTableStructure track by $index\" html-string-to-content=\"\" elem-value=\"itemRow[value[\'key\']]\" language-align=\"{{::itemRow[value[\'key\']]}}\" ng-class=\"{\'table-id\':$index==0,\'table-object\': (!!itemRow[value[\'key\']].name || !!itemRow[value[\'key\']][0].name || !!itemRow[value[\'key\']].id || !!itemRow[value[\'key\']][0].id) }\" ng-click=\"(!!itemRow[value[\'key\']].name || !!itemRow[value[\'key\']][0].name || !!itemRow[value[\'key\']].id || !!itemRow[value[\'key\']][0].id) && vm.showMore(itemRow[value[\'key\']]);\" ng-if=\"value.showInTable && value.key != \'actions\'\">{{::(itemRow[value[\'key\']].name || itemRow[value[\'key\']] )}}</td><td ng-if=\"vm.smartTableStructure[vm.smartTableStructure.length-1].buttons\"><span data-ng-switch=\"\" on=\"vm.smartTableStructure[vm.smartTableStructure.length-1].buttons.length<4\"><button data-ng-switch-when=\"true\" ng-repeat=\"action in vm.smartTableStructure[vm.smartTableStructure.length-1].buttons track by $index\" class=\"btn editable-table-button btn-xs {{action.class}}\" ng-show=\"::vm.smartTableCanUseAction(action.functionName,itemRow.type)\" ng-click=\"vm[action.functionName](itemRow,$parent.$index)\">{{::action.name}}</button><div data-ng-switch-when=\"false\"><div class=\"btn-group\" uib-dropdown=\"\" dropdown-append-to-body=\"\"><button type=\"button\" class=\"btn btn-primary\">Actions</button> <button type=\"button\" class=\"btn btn-primary\" uib-dropdown-toggle=\"\"><span class=\"caret\"></span> <span class=\"sr-only\">Toggle Dropdown</span></button><ul uib-dropdown-menu=\"\"><li><a href=\"\" ng-repeat=\"action in vm.smartTableStructure[vm.smartTableStructure.length-1].buttons track by $index\" ng-show=\"::vm.smartTableCanUseAction(action.functionName,itemRow.type)\" ng-click=\"vm[action.functionName](itemRow,$parent.$index)\">{{::action.name}}</a></li></ul></div></div></span></td></tr></tbody><tfoot><tr><td colspan=\"13\" class=\"text-center\"><div st-pagination=\"\" st-items-by-page=\"vm.smartTablePageSize\" st-displayed-pages=\"5\" st-template=\"app/pages/tables/widgets/pagination.custom.html\"></div></td></tr></tfoot></table></div>");
...
$templateCache.put("app/theme/components/pageTop/pageTop.html","<div class=\"page-top clearfix\" scroll-position=\"scrolled\" max-height=\"50\" ng-class=\"{\'scrolled\': scrolled}\"><a href=\"#/dashboard\" class=\"al-logo clearfix\"><span>UCCA</span>Admin</a> <span ng-if=\"!$hideSideBar\"><a href=\"\" class=\"collapse-menu-link ion-navicon\" ba-sidebar-toggle-menu=\"\"></a></span><div class=\"user-profile clearfix\"><div class=\"al-user-profile\" uib-dropdown=\"\"><a uib-dropdown-toggle=\"\" class=\"profile-toggle-link\"><img ng-src=\"{{::( \'Nasta\' | profilePicture )}}\"></a><ul class=\"top-dropdown-menu profile-dropdown\" uib-dropdown-menu=\"\"><li><i class=\"dropdown-arr\"></i></li><li ng-if=\"!$hideSideBar\"><a href=\"#/profile\"><i class=\"fa fa-user\"></i>Profile</a></li><li><a href=\"\" ng-click=\"vm.logout();\" class=\"signout\"><i class=\"fa fa-power-off\"></i>Sign out</a></li></ul></div></div></div>");
...
$templateCache.put("app/pages/annotation/directives/categories/categories.html","<div class=\"row annotation-type btn-raised\" ng-class=\"{ \'disabled\':defCtrl.definitionDetails.fromParentLayer, \'childCategory\':defCtrl.definitionDetails.parent != null }\"><span class=\"definition-color\" id=\"definition-color-{{defCtrl.definitionId}}\"></span> <button class=\"text-wrapper\" ng-disabled=\"defCtrl.definitionDetails.fromParentLayer\" ng-click=\"defCtrl.highLightSelectedWords(defCtrl.definitionDetails.backgroundColor)\"><span class=\"text\">{{defCtrl.definitionDetails.name}} ({{defCtrl.definitionDetails.abbreviation}})</span></button> <span class=\"category-info\" ng-click=\"defCtrl.showCategoryInfo($index)\"><i class=\"ion-information\"></i></span></div>");
$templateCache.put("app/pages/annotation/directives/annotationUnits/annotationUnits.html","<div class=\"directive-container\"><div class=\"directive-info-data-container\" id=\"directive-info-data-container-{{selCtrl.lineId}}\"><div class=\"row control-buttons-container\" ng-show=\"selCtrl.lineId != 0\"><a data-toggle=\"tooltip\" data-placement=\"top\" class=\"unit-control-btn\" title=\"Delete\"><i class=\"fa fa-times delete-btn unit-buttons\" aria-hidden=\"true\" ng-click=\"selCtrl.removeAnnotationUnit(selCtrl.lineId,$event)\"></i></a> <span ng-if=\"selCtrl.dataBlock.unitType == \'REGULAR\'\"><a data-toggle=\"tooltip\" data-placement=\"top\" class=\"unit-control-btn\" title=\"Finish\" ng-click=\"selCtrl.checkRestrictionForCurrentUnit(selCtrl.lineId)\"><i class=\"socicon unit-buttons\">b</i></a> <a data-toggle=\"tooltip\" data-placement=\"top\" class=\"unit-control-btn\" title=\"Comment\" ng-click=\"selCtrl.open(\'app/pages/annotation/templates/commentOnUnitModal.html\',\'sm\')\"><i class=\"socicon unit-buttons\">}</i> <span class=\"comment-notification\" ng-if=\"selCtrl.dataBlock.comment !=\'\'\">!</span></a> <a data-toggle=\"tooltip\" data-placement=\"top\" class=\"unit-control-btn\" title=\"Delete\"><i class=\"ion-plus-round unit-buttons\" ng-click=\"selCtrl.switchToRemoteMode($event)\"></i></a></span></div><span ng-if=\"selCtrl.lineId\">{{selCtrl.lineId}}</span> <span class=\"categories\" ng-repeat=\"cat in selCtrl.dataBlock.categories\"><span class=\"category-abbreviation\" ng-class=\"{\'shouldRefine\': cat.shouldRefine,\'refinedCategory\':cat.refinedCategory}\" ng-style=\"{\'color\':cat.color,\'background-color\':cat.backgroundColor}\">{{cat.abbreviation}}</span></span><div class=\"text-wrapper\" dir=\"{{selCtrl.languageAlign}}\"><div class=\"text\" id=\"row-{{selCtrl.lineId}}\"><span class=\"cursor\" id=\"cursor-{{selCtrl.lineId}}\">|</span></div></div></div><div ng-include=\"\'app/pages/annotation/directives/annotationUnits/dataTreeRow.html\'\" ng-if=\"selCtrl.lineId != \'0\'\"></div></div>");
$templateCache.put("app/pages/annotation/directives/annotationUnits/dataTreeRow.html","<div class=\"categorized-word\" ng-repeat=\"lineObj in selCtrl.dataBlock.AnnotationUnits\" ng-class=\"{\'hidden\':lineObj.gui_status==\'HIDDEN\',\'closed-annotation-unit\':lineObj.gui_status==\'COLLAPSE\'}\"><div ng-show=\"lineObj.AnnotationUnits.length\" class=\"expand-btn\" ng-click=\"selCtrl.toggleAnnotationUnitView($event);\" ng-if=\"lineObj.unitType == \'REGULAR\'\"><i ng-class=\"{\'ion-minus-round\':lineObj.gui_status==\'OPEN\', \'ion-plus-round\':lineObj.gui_status==\'COLLAPSE\'}\"></i></div><annotation-units class=\"has-elements\" ng-class=\"{\'has-elements\': selCtrl.dataBlock.AnnotationUnits.numOfAnnotationUnits > 0, \'remote-unit\':lineObj.unitType == \'REMOTE\' || lineObj.unitType == \'IMPLICIT\', \'highlight-unit\':lineObj.unitType == \'REMOTE\' || lineObj.unitType == \'IMPLICIT\', \'hidden\':lineObj.gui_status==\'HIDDEN\' }\" preview-line=\"lineObj.text\" categories=\"lineObj.categories\" control=\"selCtrl.keyController\" line-id=\"lineObj.annotation_unit_tree_id\"></annotation-units></div>");
...
$templateCache.put("app/pages/edit/passages/texts/edit.passages.texts.html","<div class=\"row\" ba-panel=\"\"><div class=\"col-md-12\"><div class=\"input-demo radio-demo row\"><div class=\"col-md-12\"><label class=\"radio-inline custom-radio nowrap col-md-12\"><input type=\"radio\" name=\"inlineRadioOptions\" id=\"inlineRadio2\" value=\"File\" ng-model=\"vm.textFrom\"> <span class=\"form-group\"><label for=\"input01\">Text</label> <input type=\"file\" class=\"form-control\" id=\"input01\" placeholder=\"Upload\" onchange=\"angular.element(this).scope().vm.readTextFromFile(this)\" ng-focus=\"vm.textFrom = \'File\'\"></span></label></div><div class=\"col-md-12\"><label class=\"radio-inline custom-radio nowrap col-md-12\"><input type=\"radio\" name=\"inlineRadioOptions\" id=\"inlineRadio1\" value=\"Input\" ng-model=\"vm.textFrom\"> <span class=\"form-group\"><label for=\"textarea01\">Textarea</label> <textarea placeholder=\"Default Input\" class=\"form-control\" id=\"textarea01\" ng-model=\"vm.text\" ng-focus=\"vm.textFrom = \'Input\'\"></textarea></span></label></div></div><button type=\"submit\" class=\"btn btn-primary\" ng-click=\"vm.edit();\">Submit</button> <button type=\"button\" class=\"btn btn-danger\" ng-click=\"vmEditCtrl.back();\">Cancel</button></div></div>");
$templateCache.put("app/pages/edit/projects/layers/edit.projects.layers.html","<div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Sources Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
...
$templateCache.put("app/pages/ui/modals/modalTemplates/largeModal.html","<div class=\"modal-content\" id=\"html-content-modal\"><div class=\"modal-header\"><button type=\"button\" class=\"close\" ng-click=\"$dismiss()\" aria-label=\"Close\"><em class=\"ion-ios-close-empty sn-link-close\"></em></button><h4 class=\"modal-title\">{{name}}</h4></div><div class=\"modal-body\"><span>{{description}}</span><pre>{{jsonString}}</pre></div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-primary\" ng-click=\"$dismiss()\">Ok</button></div></div>");
...
//# sourceMappingURL=../maps/scripts/app-5981fa8496.js.map
