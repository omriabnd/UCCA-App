...
angular.module("zAdmin").run(["$templateCache", function($templateCache) {$templateCache.put("app/pages/categories/categories.html","<div ba-panel=\"\" ba-panel-title=\"Search Form\" ba-panel-class=\"with-scroll\"><div class=\"add-asset-btn-container\"><button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"vm.editRow({})\" permission=\"\" permission-only=\"[\'ADMIN\',\'PROJECT_MANAGER\']\">Add New category</button></div><div ng-include=\"\'app/pages/form/layouts/widgets/search.html\'\"></div></div><div class=\"row\"><div class=\"col-md-12\"><div ba-panel=\"\" ba-panel-title=\"Categories Table\" ba-panel-class=\"with-scroll\"><div include-with-scope=\"app/pages/tables/widgets/smartTable.html\"></div></div></div></div>");
...
//# sourceMappingURL=../maps/scripts/app-392fb38001.js.map
