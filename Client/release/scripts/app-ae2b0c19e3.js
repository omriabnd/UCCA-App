...
(function () {
  ...
  AnnotationPageCtrl.$inject = ["DefaultHotKeys", "TaskMetaData", "AnnotationTextService", "DataService", "$rootScope", "$scope", "hotkeys", "HotKeysManager", "Definitions", "ENV_CONST", "Core", "restrictionsValidatorService", "$timeout", "$state"];
  angular.module('zAdmin.pages.annotation')
...
$templateCache.put("app/theme/components/pageTop/pageTop.html","<div class=\"page-top clearfix\" scroll-position=\"scrolled\" max-height=\"50\" ng-class=\"{\'scrolled\': scrolled}\"><a href=\"#/dashboard\" class=\"al-logo clearfix\"><span>UCCA</span>App</a> <span ng-if=\"!$hideSideBar\"><a href=\"\" class=\"collapse-menu-link ion-navicon\" ba-sidebar-toggle-menu=\"\"></a></span><div class=\"user-profile clearfix\"><div class=\"al-user-profile\" uib-dropdown=\"\"><a uib-dropdown-toggle=\"\" class=\"profile-toggle-link\"><img ng-src=\"{{::( \'Nasta\' | profilePicture )}}\"></a><ul class=\"top-dropdown-menu profile-dropdown\" uib-dropdown-menu=\"\"><li><i class=\"dropdown-arr\"></i></li><li ng-if=\"!$hideSideBar\"><a href=\"#/profile\"><i class=\"fa fa-user\"></i>Profile</a></li><li><a href=\"\" ng-click=\"vm.logout();\" class=\"signout\"><i class=\"fa fa-power-off\"></i>Sign out</a></li></ul></div></div></div>");
...
//# sourceMappingURL=../maps/scripts/app-ae2b0c19e3.js.map
