...
(function () {
  ...
  AnnotationPageCtrl.$inject = ["DefaultHotKeys", "TaskMetaData", "AnnotationTextService", "DataService", "$rootScope", "$scope", "hotkeys", "HotKeysManager", "Definitions", "ENV_CONST", "Core", "restrictionsValidatorService", "$timeout"];
  angular.module('zAdmin.pages.annotation')
...
(function() {
    ...
    DataService.$inject = ["$http", "apiService", "$rootScope", "restrictionsValidatorService", "ENV_CONST", "Core", "$timeout"];
    angular.module('zAdmin.annotation.data')
...
//# sourceMappingURL=../maps/scripts/app-62343e52bb.js.map
